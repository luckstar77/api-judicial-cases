export const TAIWAN_CITY_DISTRICTS = {
  ...
  新北市: [
    '板橋區','三重區','中和區','永和區','新莊區','新店區','樹林區','鶯歌區','三峽區','淡水區','瑞芳區','土城區','蘆洲區','五股區','泰山區','林口區','深坑區','石碇區','坪林區','三芝區','石門區','八里區','平溪區','雙溪區','貢寮區','金山區','萬里區','汐止區','烏來區'
  ],
  桃園市: [
    '桃園區','中壢區','平鎮區','八德區','楊梅區','龍潭區','大溪區','大園區','龜山區','蘆竹區','新屋區','觀音區','復興區'
  ],
  台中市: [
...
export type TaiwanCity = keyof typeof TAIWAN_CITY_DISTRICTS;
export type TaiwanDistrict<C extends TaiwanCity> = (typeof TAIWAN_CITY_DISTRICTS)[C][number];
